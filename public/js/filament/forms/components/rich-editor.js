    ...
    p = function (i) {
        ...
        if (
            ...
            for (t in n.attributes)
                ((e = n.attributes[t]), r.setAttribute(t, e));
...
var $t = class extends ht {
        ...
        isEqualTo(t) {
            return (
                super.isEqualTo(...arguments) || ms(this.objects, t?.objects)
            );
        }
        contentsForInspection() {
            return {
        ...
        insertLineBreak() {
            ...
            if (t.shouldDecreaseListLevel())
                return (
                    ...
                    this.setSelection(t.startPosition)
                );
...
var Kn = new WeakMap(),
    ...
    gi = class {
        ...
        get labels() {
            ...
            return (
                e && [this.element, null].includes(e.control) && t.push(e),
                t
            );
        }
        get disabled() {
    ...
    ye = class extends HTMLElement {
        ...
        get inputElement() {
            ...
            if (this.parentNode) {
                ...
                return (
                    this.parentNode.insertBefore(n, this.nextElementSibling),
                    n
                );
            }
        }
